  ...
  <div id="EmailView" class="bg-[#F6F8FC] h-screen">
    ...
    <div class="flex items-center p-2">
     ...
     <!--search field-->
      <div class="flex w-full justify-between">
        <div class="w-full max-w-[700px] bg-gray-200 flex items-center p-1 px-1.5 rounded-full">
          <IconComponent
            iconString="magnify"
            iconColor="#636363"
            iconSize="22"
    ...
    <div class="flex w-full justify-between">
      ...
      <div id="SideMenu" class="w-[300px]">
        <div class="flex items-center justify-center bg-sky-200 w-36 h-8 mt-2 ml-2 p-7 cursor-pointer rounded-2xl ">
        ...
        <div class="flex w-[250px] justify-between px-6 py-1.5 bg-blue-100 rounded-r-full">
          ...
          <div class="text-xs justify-end font-semibold">
            26
          </div>
        </div>
      ...
      <div class="m-4">
        <div class="w-6 h-6 flex justify-center mb-7">
          <img class="object-center" src="../../assets/img/GoogleCalendar.png" alt="">
        </div>

        <div class="w-6 h-6 flex justify-center mb-7">
          <img class="object-center" src="../../assets/img/GoogleKeep.png" alt="">
        </div>

        <div class="w-6 h-6 flex justify-center mb-7">
          <img class="object-center" src="../../assets/img/GoogleTasks.png" alt="">
        </div>

        <div class="w-6 h-6 flex justify-center mb-7">
          <img class="object-center" src="../../assets/img/GoogleContacts.png" alt="">
        </div>
