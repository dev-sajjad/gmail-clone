<template>
    <div id="MessageRow">
        <div class="border-b hover:border-b-0 hover:border hover:border-gray-200 hover:shadow-md cursor-pointer" >
            <div class="flex items-center justify-between">
              <div class="flex items-center px-4 py-2">
                    <component :is="CheckboxBlankOutlineIcon" :size="22" fillColor="#636363" />
                    <StarOutlineIcon :size="22" fillColor="#636363"  class="ml-4"/>
              </div> 
              <div class="flex items-center w-full">
                <RouterLink to="email/message">
                    <div class="flex items-center w-full">
